...
namespace HotelWaveFinal.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomTypeId,TypeName,Description,BasePrice")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomTypeId,TypeName,Description,BasePrice")] RoomType roomType)
        {
